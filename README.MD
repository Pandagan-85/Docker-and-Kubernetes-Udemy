...
AspettoARGENVQuandoSolo build timeBuild + RuntimeVisibilitàDockerfile onlyContainer processesOverride--build-arg-e al runEreditàNoSì (processi figli)Uso tipicoVersioni, build configApp config, secrets
